...
class JobManager
{
    ...
    {
        try {
            $projectDir = $this->container->getParameter('docker_jobs.docker.container_working_dir');
            if (!empty($projectDir)) {
        ...
        $rootDir = $this->container->getParameter('docker_jobs.docker.container_working_dir');
